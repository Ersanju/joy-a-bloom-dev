...
class DecorInfoPage extends StatefulWidget {
  const DecorInfoPage({super.key});

  @override
  State<DecorInfoPage> createState() => _DecorInfoPageState();
}

class _DecorInfoPageState extends State<DecorInfoPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Birthday/Wedding Décor'),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Celebrate your special occasions with our beautifully customized birthday and wedding décor. '
              'From balloons and lights to flowers and themed settings, we turn your dreams into memories.',
